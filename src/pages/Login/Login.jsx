...
export function Login() {
    ...
    return (
        <div className="bg-black md:bg-login-background bg-no-repeat flex f bg-cover flex-col h-full items-center">
            <div className="w-full flex flex-col items-center bg-black/50">
                <Header isLogin={true} />
